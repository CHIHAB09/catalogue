...
<body>
    ...
    <div class="contenue">
        ...
        Aenean quis ex sit amet lorem pretium ultricies. Sed hendrerit lobortis scelerisque. Vestibulum tortor erat, ultricies vel metus nec, ultricies congue nunc. Aliquam erat volutpat. Phasellus blandit, arcu sed interdum dapibus, diam diam finibus erat, id tempus nulla nisi eget nunc. Vestibulum ut orci a tellus accumsan egestas quis nec turpis. Nunc facilisis tempor tincidunt. Donec rutrum purus vitae elit vulputate, in lacinia lectus dignissim. Vivamus vitae risus urna. Sed in eleifend risus, eu ultrices mauris. Nam in erat vitae lectus euismod tincidunt sit amet sed mi.
    ...
    <div class="video">
        <video src="image/video/puma.mp4" width="640" height="360" poster="image/poster.png" id="film1" controls>
            <a href="media/wildlife.mp4">Télécharger la vidéo</a>
        </video>
    </div>
    <div class="img" id="lecteur">
            <img src="image/iconedemarrer.png" onclick="play(1);" />
            <img src="image/iconepause.png" onclick="pause();" />
    </div>
</div>
