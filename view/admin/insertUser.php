...
<html lang="fr">
    ...
    <h1 class="display-4 text-center mb-4">Catalogue | Ajouter un utilisateur</h1>
    <p>Bienvenue <?=$_SESSION['pseudo']?></p>
    </header>
        
        <main class="container">
            <h1 class="text-center mt-4">Admin - <?=$_SESSION['pseudo']?></h1>
            <p class="lead text-center">Ce formulaire permet d'ajouter une nouvelle utilisateur dans la liste</p>
    ...
    ?>
            ...
            <form id="formulaire" method="POST">
               <div class="form-group row">
                   ...
                   <input name="nom" type="text" class="form-control col-md-9" id="nom" placeholder="Entrez votre nom" required>
               ...
               <div class="form-group row">
                   ...
                   <input name="prenom" type="text" class="form-control col-md-9" id="prenom" placeholder="Entrez votre prenom" required>
               ...
               <div class="form-group row">
                   ...
                   <input name="pseudo" type="text" class="form-control col-md-9" id="pseudo" placeholder="Entrez un pseudo" required>
               ...
               <div class="form-group row">
                   ...
                   <input name="pwd" type="PWD" class="form-control col-md-9" id="pwd" placeholder="Entrez un mot de passe" required>
                   <div class="invalid-feedback text-left offset-md-3">Vous devez entrez mot de passe</div>
               </div>
